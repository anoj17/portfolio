...
const Skill = () => {
    ...
    const AnimatedDiv = ({ value, x, y }) => {
        ...
        return <>
            <motion.div className='py-3 px-6 font-bold bg-dark text-light flex justify-center items-center rounded-3xl shadow-dark cursor-pointer absolute'
    ...
    return <>
        ...
        <div className='w-full h-screen flex justify-center items-center relative bg-circularImage rounded-full'>
            ...
            <div className='p-5 font-bold bg-dark text-light flex justify-center items-center rounded-3xl shadow-dark cursor-pointer'>
                Web
            </div>
